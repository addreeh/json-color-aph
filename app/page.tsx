    ...
    <div className="min-h-screen bg-background transition-colors duration-300 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-foreground">HSON Color Palette Viewer</h1>
        ...
        <div className="space-y-2">
          ...
          />
          <div className="flex gap-2">
            <Button onClick={() => parseJsonInput(jsonInput)}>Load Colors</Button>
            <Button variant="outline" onClick={() => setCopyType(copyType === "name" ? "value" : "name")}>
            ...
            {Object.entries(colorData).map(([name, color]) => (
              ...
              >
                ...
                <div className="p-2">
                  ...
                  <div className="font-mono text-xs text-muted-foreground truncate">{color}</div>
                </div>
                <div
                  className={cn(
